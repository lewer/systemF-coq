...
doc:
	rm -rf html
	mkdir html
	coqdoc -utf8 -g -d html -toc F01_Defs.v F03_Insert_kind.v F05_Remove_var.v F04_Env_subst.v F06_Regularity.v F02_Inference.v 
...
doc2: coq2html/coq2html
	...
	coq2html/coq2html -o 'html2/%.html' *.glob F01_Defs.v F03_Insert_kind.v F04_Env_subst.v F05_Remove_var.v F06_Regularity.v F02_Inference.v 
