...
(** * VI. Regularité 
Dans cette partie, nous nous attelons à prouver la propriété de régularité suivante : si un terme est typable avec un type [T] dans un environnement, alors ce type est "kindable" dans ce même environnemnt.*)

(** Pour cela nous avons besoin d'un premier lemme, stipulant que la possibilité de l'extraction d'un type dans un environnement bien formé entraîne la kindabilité de ce type dans cet environnement. *)
